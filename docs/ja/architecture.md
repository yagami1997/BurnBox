...
現在の工学的基準線は `4.3 GB / 870 parts` および `11 GB / 2200 parts` までの大容量転送で検証済みです。BurnBox 2.2.2 では 2.2.1 の基準に加え、frontend-JS の maintainability pass が完了しています。次の実装段階は resumable upload です。
