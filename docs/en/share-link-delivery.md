...
BurnBox 2.2.0 preserves the 2.1.0 and 2.1.1 share-model redesign that fixed those problems without turning the system into a larger platform.
...
This separation remains one of the main privacy improvements carried forward into 2.2.0.

## Operator-facing consequences

The 2.2.0 route baseline still produces three practical outcomes:
